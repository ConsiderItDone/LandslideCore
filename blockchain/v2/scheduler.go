...
func (sc *scheduler) setPeerRange(peerID p2p.ID, base, height int64) error {
...
func (sc *scheduler) markReceived(peerID p2p.ID, height, size int64, now time.Time) error {
